...
function About() {
  return (
    ...
    <h2 id="interests-heading">Interests</h2>
      ...
      <div id="interest">
        <TbBracketsAngleOff id="icon"/> <Interest text="Software Engineering" />
      </div>
      <div id="interest">
      ...
      <div id="interest"><PiBoxingGloveDuotone id="icon"/> <Interest text="Martial Arts" /></div>
      <div id="interest"><PiTelevisionFill id="icon"/> <Interest text="Movies & Web Series" /></div>
